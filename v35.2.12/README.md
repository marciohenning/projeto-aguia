...
## V35.2.12 — Correção de navegação

Correção para o problema em que a aplicação abria, mas os botões não acessavam as telas.

Ajustes:
- navegação robusta por `data-tab`;
- cartões da tela inicial voltam a abrir as seções;
- botão Academia/Iniciar treino corrigido;
- respostas do treino corrigidas;
- app abre direto na Jornada;
- login não bloqueia o acesso.
